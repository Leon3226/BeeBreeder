...
namespace BeeBreeder.Breeding.Evaluation.Chance
{
    public class BeeCrossChance
    {
        ...
        {
            var firstSpecieChromosome = (Chromosome<string>)_first[Constants.StatNames.Specie];
            var secondSpecieChromosome = (Chromosome<string>)_second[Constants.StatNames.Specie];
